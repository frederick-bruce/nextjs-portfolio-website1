        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Frederick Bruce</h2>
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300 hover:bg-gray-700">
                      <FaGithub />
                    </div>
                  </a>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/d6633e42-adae-4ed0-abf3-f48cb4b789ea"
                method="POST"
